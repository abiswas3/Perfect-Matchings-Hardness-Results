...
As $\BipartiteG$ is $(D, \epsilonA \na)$ non blocking, we know that at least one of these edges will be connected to vertices in $Y$, such that they have no edges in $\cup_{i=1}^{z} (M_i \cup M'_i)$ already incident on them.
