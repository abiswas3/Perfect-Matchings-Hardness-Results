...
In previous work, \citet{Austrin_2022} showed  refuting perfect matchings in sparse $d$-regular random graphs requires proofs with degree $\BigOmega{n/\log n}$ in the PC and SoS proof system \highlight{on average}.
