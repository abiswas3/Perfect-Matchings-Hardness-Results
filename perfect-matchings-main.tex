...
\begin{figure*}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{assets/stock.png}
...
This implies that there \highlight{MUST} be edges incident on $Y$ from sets that are neither $Y$ or $\BadSet$.
