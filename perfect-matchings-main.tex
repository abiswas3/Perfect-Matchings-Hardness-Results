...
Perhaps the most fundamental problem in all of theorey of computation is to provide an answer to the question: ``\textit{Given a true statement $A$, what is the shortest proof of the claim that $A$ is true?}''
...
\highlight{Change this completely}
