...
\ari{Add a bit about topological minors}.
...
\highlight{Expand on this. This is the key step.}
...
\item{ As $n$ is odd, and $\Size{\Vertices{G_{\EmbeddingFunc}}}$ is odd, we have that $U = G[V \setminus G_{\EmbeddingFunc}]$ is even, and by the balanced partitioning we have $\MinimalDegree{G[U]} \geq \frac{11d}{16}$.
    By Theorem \ref{thm:perfect-matching}, $G[U]$ has a perfect matching $M$.
