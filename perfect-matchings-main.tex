...
To show this spectral bound, they rely on the interlacing theorem\footnote{https://simple-complexities.github.io/eigenvalue/interlacing/2020/02/10/interlacing.html} and weyl's theorem\footnote{\url{https://terrytao.wordpress.com/tag/weyls-theorem/}} from Linear algebrea, along with the fact that random graphs are strong expanders with $\lambda \leq \sqrt{d-1} - \SmallO{1}$.
...
Let $G$ be a $\EnDeeLambda$ graph, and $\BipartiteG$ be the bipartitle representation of $G_{\GreenB}$, where $|G_{\GreenB}| = \na = \alpha n$, for some universal constant $\alpha \in [3/16, 5/16]$.
