...
\citet{Austrin_2022} made partial progress on the above problem by showing that refuting the existence of perfect matchings in \emph{random $d$-regular graphs} in the Sum-of-Squares and Polynomial Calculus proof system requires long proofs.
...
Their hardness proof works as follows.
