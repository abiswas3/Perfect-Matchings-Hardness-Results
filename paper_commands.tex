...
\newcommand{\ari}[1]{\marginnote{\textcolor{blue}{\textbf{$\star\star\star$}}}\textcolor{blue}{\textbf{Ari:} #1}}
\newcommand{\rajko}[1]{\marginnote{\textcolor{red}{\textbf{$\star\star\star$}}}\textcolor{red}{\textbf{Rajko:} #1}}
...
\newcommand{\CutEdges}[3]{e_{#3}(#1, #2)}
\newcommand{\IncidentEdges}[1]{\mathsf{E}(\rightarrow #1)}
\newcommand{\CutEdgesSet}[3]{\mathsf{E}_{#3}(#1, #2)}
...
\newcommand{\GlobalEdgeSet}{\mathcal{E}}
