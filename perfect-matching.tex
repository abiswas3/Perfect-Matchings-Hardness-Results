...
\textbf{Case 2}: \ari{Comment from referee: Maybe state that in case 2 you are using that $f >= 2$ similarly to how you stated the upper bound in case 1?  } If $\Size{S} > \Size{T}$, then 
  \begin{align}
